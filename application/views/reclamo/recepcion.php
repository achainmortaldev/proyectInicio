...
<?php $this->start('contenido') ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>RECEPCION RECLAMO<small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"> Reclamo</a></li>
        <li class="active">Recepción Reclamo</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content">
      <div class="row" id="divPanelReclamo" >
        <div class="col-md-12">
          <div class="box">
                    ...
                    <div class="box box-primary setup-content" data-step="step-1">
                      ...
                      <div class="box-body">
                        <div class="row">
                          <div class=" col-lg-6 col-md-6 col-ms-12">
                            <div class="form-group">
                              <label for="reclamo[reclamante]">Reclamante</label>
                              <select class="form-control input-lg" name="reclamo[reclamante]" >
                          ...
                          <div class=" col-lg-6 col-md-6 col-ms-12">
                            <div class="form-group">
                              <label for="pronunciamiento[pronunciamiento]">Parentesco</label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                              <label for="reclamo[numero_piso]" class="control-label">Num Piso</label>
                              <input maxlength="100" type="text" class="form-control" placeholder="Número de piso" name="reclamo[numero_piso]" />
                            </div>
                          </div>

                          <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                              <label for="reclamo[numero_piso]" class="control-label">Dpto</label>
                              <input maxlength="100" type="text" class="form-control" placeholder="Número de piso" name="reclamo[numero_piso]" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="reclamo[direccion]" class="control-label">Dirección</label>
                              <input maxlength="100" type="text" class="form-control" placeholder="dirección" name="reclamo[direccion]" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="reclamo[telefono]" class="control-label">Télefono</label>
                              <input maxlength="100" type="text" class="form-control" placeholder="Télefono" name="reclamo[telefono]" />
                            </div>
                          </div>

                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="reclamo[telefono_mobil]" class="control-label">Célular</label>
                              <input maxlength="100" type="text" class="form-control" placeholder="Célular" name="reclamo[telefono_mobil]" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="reclamo[referencia]" class="control-label">Referencia</label>
                              <input maxlength="100" type="text" class="form-control" placeholder="referencia" name="reclamo[referencia]" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="reclamo[observacon]" class="control-label">Observación</label>
                              <textarea name="" rows="5" class="form-control" placeholder="observación del reclamo" name="reclamo[observacon]"></textarea>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input id="inputRecepcionDoc" name="inputRecepcionDoc[]" type="file" multiple accept="image" class="form-control">
                            </div>
                          </div>
                        </div>
